package com.sunyard.demo_swagger.config;
...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"com.sunyard.demo_swagger.controller"})
...
//    @Value("${base.location}")//项目初始目录  一般就是自己springboot启动类的包名
    ...
    public Docket commonDocket() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .pathMapping("/")
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.sunyard.demo_swagger.controller"))//指向自己的controller即可
...
//设置文档信息
    private ApiInfo apiInfo(String desc) {
        return new ApiInfoBuilder()
                ...
                .title(desc)
                //设置作者联系方式,可有可无
                .contact(new Contact("Ouqiang", "https://qiang.ou@sunyard.com", "qiang.ou@sunyard.com"))
                //版本号
                .version("1.0")
                //描述
                .description("API 描述")
